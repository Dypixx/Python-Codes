...
saved = f"""TOTAL Years: {years}, Months: {months}, Days: {days}, Weeks: {weeks}, Total Days: {delta.days}, Total Minutes: {total_minutes}, Total Seconds: {total_seconds}"""
print(saved)
...
next_age = (now.year - birthday.year) + (1 if next_birthday.year > now.year else 0)
